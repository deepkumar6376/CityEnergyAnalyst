...
def moo_optimization(locator, weather_file, settings):
    '''
    ...
    settings.num_tot_buildings = total_demand.Name.count()
...
def run_as_script(scenario_path=None):
    ...
    moo_optimization(locator=locator, weather_file= weather_file, settings = settings)
