...
def calc_pareto_electricity(locator, settings):
    ...
    elecCosts = totalElec * settings.ELEC_PRICE # [CHF]
    elecCO2 = totalElec * settings.EL_TO_CO2 * 3600E-6 # [kg CO2]
    elecPrim = totalElec * settings.EL_TO_OIL_EQ * 3600E-6 # [MJoil-eq]
